...
zokou({ nomCom: "dev", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "OBED", numero: "254701082940" },
      { nom: "᚛VMD TECH᚜", numero: "254791637868" },
      { nom: "TRIPPLE TECH", numero: "254714118831" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "WELCOME TO OBED-TECH HELP CENTER! ASK FOR HELP FROM ANY OF THE DEVELOPERS BELOW:\n\n";
